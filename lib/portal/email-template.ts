        ...
        <div style="background-color: #F9F8F6; border: 1px solid #E2DBCF; padding: 32px; margin-bottom: 32px;">
          ...
          <div style="margin: 0;">
            <div style="display: flex; justify-content: space-between; align-items: center; padding-bottom: 12px; border-bottom: 1px solid #E2DBCF; margin-bottom: 16px;">
              <span style="color: #9E8461; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em;">Email</span>
              <span style="color: #264C3F; font-size: 14px; font-weight: 500;">${recipientEmail}</span>
            </div>
            <div style="display: flex; justify-content: space-between; align-items: center; padding-bottom: 12px; border-bottom: 1px solid #E2DBCF; margin-bottom: 16px;">
              <span style="color: #9E8461; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em;">Password</span>
              <span style="color: #264C3F; font-size: 14px; font-weight: 500; font-family: 'Courier New', monospace;">${password}</span>
            </div>
            <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 8px;">
              <span style="color: #9E8461; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em;">Portal URL</span>
              <a href="${portalUrl}" style="color: #264C3F; font-size: 14px; font-weight: 700; text-decoration: underline; text-underline-offset: 4px;">xecuit.com/portal</a>
            </div>
          </div>
        </div>
